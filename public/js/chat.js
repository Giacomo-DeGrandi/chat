        ...
        if(testValidText()){
            ...
            fetch("../../php/controller/chat_controller.php", {
                ...
                .then(d =>{
                    ...
                    div.setAttribute('class','text-end float-end border border-danger rounded-left p-2 w-75 shadow-sm mb-4 mx-2')
            ...
            .then(d =>{
                ...
                for(let u=0;u<d.length;u++){
                    ...
                    if(vu[1]===id){
                        ...
                        div.setAttribute('class', 'text-start float-start border border-dark rounded-right p-2 w-75 shadow-sm mb-4 mx-2')
